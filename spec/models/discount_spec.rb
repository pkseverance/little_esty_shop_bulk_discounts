...
RSpec.describe Discount do
    ...
    describe 'relationships' do
        ...
        it '#edit_discount' do
            ...
            expect(@discount3.percent_discount).to eq(50.0)
            expect(@discount3.quantity_threshold).to eq(100)

            @discount3.edit_discount(88, 400)
            @merchant1.reload

            expect(@discount3.percent_discount).to eq(88.0)
            expect(@discount3.quantity_threshold).to eq(400)
